...
ActiveRecord::Schema.define(version: 2021_08_30_175813) do
  ...
  create_table "helphulnesses", force: :cascade do |t|
    t.integer "user_id"
    t.integer "review_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "reviews", force: :cascade do |t|
    t.integer "user_id"
    t.integer "food_id"
    t.integer "smell_strong", default: 5, null: false
    t.integer "taste_strong", default: 5, null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "remember_created_at"
    t.string "name", null: false
    t.integer "sweet_like", default: 3, null: false
    t.integer "salty_like", default: 3, null: false
    t.integer "bitter_like", default: 3, null: false
    t.integer "sour_like", default: 3, null: false
    t.integer "spicy_like", default: 3, null: false
    t.boolean "is_active", default: true, null: false
    t.text "introduction"
